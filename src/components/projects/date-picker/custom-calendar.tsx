...
export const CustomCalendar = () => {
  const { rawDate, setRawDate, setDates } = useDatePickerContext()
  ...
  return (
    <Calendar
      ...
      classNames={{
        ...
        day: 'relative w-full h-full p-0 text-center last:data-selected:rounded-r-md aspect-square first:data-selected:rounded-l-md rounded-none bg-transparent text-white/70 data-today:text-white data-today:font-bold data-today:bg-white/5 data-outside:text-white/30 data-selected:bg-white/10 overflow-clip',
        day_button:
